...
class PositionedCropTransformation(
    @FloatRange(from = 0.0, to = 1.0) xPercentage: Float, @FloatRange(
        from = 0.0,
        to = 1.0
    ) yPercentage: Float
) :
    ...
    override fun equals(other: Any?): Boolean {
        return other is PositionedCropTransformation
    }

    companion object {

        private const val ID = "PositionedCropTransformation.com.bumptech.glide.load.resource.bitmap.x:0.y:0"
